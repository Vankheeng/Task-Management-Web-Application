...
public enum ErrorCode {
    ...
    TEAMMEMBER_EXISTED(3002, "This user is already member of this team", HttpStatus.FORBIDDEN),
    ...
    STATUS_CANT_DELETE(7002, "Status is being used by tasks and cannot be deleted", HttpStatus.BAD_REQUEST),
    ...
    LAST_ADMIN_CANT_LEAVE(9003, "Last admin can not leave group", HttpStatus.FORBIDDEN),
    LAST_ADMIN_ROLE_CANT_BE_UPDATE(9004, "Last admin can not become a member", HttpStatus.FORBIDDEN),
