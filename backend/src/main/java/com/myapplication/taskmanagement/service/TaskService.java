...
public class TaskService {
    ...
    public List<TaskResponse> getMyTask(LocalDate startDay,
                                               LocalDate endDay){
        ...
        return taskAssignmentRepository.findAllByUser_IdAndActive(userId, true)
                ...
                .filter(task->
                    ...
                    !task.getDeadline().isBefore(startDay)
                    && !task.getDeadline().isAfter(endDay)
                )
                .map(taskMapper::toTaskResponse)
                .toList();
    }
    ...
    public String deleteTask(String taskId){
        ...
        securityUtils.checkAdminRole(task.getTaskList().getProject().getTeam().getId());
